...
function bs_err(a,b){
    ...
    //复原所有状态
    recover_e();
	console.log(' bs_err(a,b)');
}
//错误后的动画重新盖上
function bs_last(e,g){
  	g.src='https://www.mugeda.com/c/user/data/5748fa30a3664e1b3c0001d6/5a7ff7b5347a1955126c7a7c.png';
...
function recover(){
    ...
    var b = [];
        ...
        b[i] = scene.getObjectByName("a"+i);
         //
        b[i].src =  'https://www.mugeda.com/c/user/data/5748fa30a3664e1b3c0001d6/5a7ff7b5347a1955126c7a7c.png'; 
