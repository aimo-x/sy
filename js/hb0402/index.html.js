...
function ge_img(){
    ...
    appC.innerHTML = "";
    var companyP = {x:192, y:32 , size: 29.66 + Fsize, fontWeight:"bold",fill:"#494742"};
    var shopP = {x:368, y:1355, size: 19 + Fsize, fontWeight:"bold",fill:"#2c2c2c"};
    var addressP = {x:369, y:1379, size: 12 + Fsize, fontWeight:"bold",fill:"#2c2c2c"};
    var phoneP = {x:607, y:1358, size: 13.48 + Fsize, fontWeight:"bold",fill:"#ffffff"};
    var benefitP = {x:370, y:1315, size: 16 +Fsize, fontWeight:"bold",fill:"#2c2c2c"};
